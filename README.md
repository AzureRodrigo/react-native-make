...
```bash
yarn add -D @azurerodrigo/react-native-make
# OR
npm i -D @azurerodrigo/react-native-make
```
...
- In your React Native project, `yarn link @azurerodrigo/react-native-make`
- In the package.json of your React Native project, in dependencies add "@azurerodrigo/react-native-make" : "0.0.0"
